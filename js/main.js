...
/*
    ...
    -- Variavle Declaration in JavaScript --
    Primitive Data Types: String, Number, Boolean, Undefines, Null      <=== immutable, cannot change them
...
// console.log() is equivalent to pythons print() function
console.log(myName);
console.log(typeof myName);

// Strings can be created using '', "", or ``, The tick marks (``) have a special behavior to format the string
// Tick marks + ${varName} is is equiv to f'{}' in python
